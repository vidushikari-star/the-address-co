...
import { ReelStoryboardEditor } from "@/components/marketing/reel-storyboard-editor"
...
export default async function MarketingContentPage({ searchParams }: Props) {
  ...
  const schedulingEnabled = isMarketingSchedulingEnabled()
