...
export function PropertyCard({
  ...
  return (
    <button className="group flex w-full items-start justify-between rounded-3xl border border-border/60 bg-card p-6 text-left transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/20 hover:bg-background">
